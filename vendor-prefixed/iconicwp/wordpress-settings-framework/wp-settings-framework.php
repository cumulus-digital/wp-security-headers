 ...
 * @license proprietary?
 *
 * Modified by Daniel Vena on 30-September-2024 using Strauss.
...
if ( ! class_exists( 'CWSH_WordPressSettingsFramework' ) ) {
	/**
	 * CWSH_WordPressSettingsFramework class
	 */
	class CWSH_WordPressSettingsFramework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * CWSH_WordPressSettingsFramework constructor.
		 *
