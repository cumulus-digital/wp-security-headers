...
return array(
	...
	'MANDATORY: string_to_search' => array (
		'filter_on' => 'MANDATORY: field to search on, see later for filtering', // source-file/blocked-uri/script-sample/referrer/document-uri/original-policy
		'case_description' => '', // Optional: URL for description
		'comment' => '' // Optional: a… comment!
		)
	 */
	';(function installGlobalHook(window)' => array(
		'filter_on'        => 'script-sample',
